...
public class Purchases {
    ...
    public Purchases(int id, int code, String product_name, int purchase_amount, double purchase_price, double purchase_subtotal, String supplier_name_product, String purchaser, String created, double total) {
        this.id = id;
        this.code = code;
